        ...
        child: Column(
          ...
          children: [
              ...
              builder: (context, child) {
                return Column(
                  children: [
                    ...
                    Text(
                      'Contador: ${_counterModel.counter}',
                      style: TextStyle(
                        fontSize: 48,
            ...
            ListenableBuilder(
              listenable: _counterModel,
              builder: (context, child) {
                // COMPLETE AQUI: Mostre a mensagem do modelo
                return Text(_counterModel.message);
              },
            ),
            SizedBox(height: 20),
            ...
            Row(
              ...
              children: [
                ...
                ElevatedButton(
                  ...
                  child: Text('Adicionar Quintuplo'),
                ),
              ],
            ),
            SizedBox(height: 20),
